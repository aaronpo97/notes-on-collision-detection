...
\begin{mdframed}[linecolor=black!30!white,linewidth=.5pt,extratopheight=1em]
    \lstinputlisting[language=C++]{code-examples/PointInAABB.cpp}
\end{mdframed}
...
\begin{mdframed}[linecolor=black!30!white,linewidth=.5pt,extratopheight=1em]
    \lstinputlisting[language=C++]{code-examples/AABBIntersection.cpp}
\end{mdframed}
...
\begin{mdframed}[linecolor=black!30!white,linewidth=.5pt,extratopheight=1em]
    \lstinputlisting[language=C++]{code-examples/AABBOverlap.cpp}
\end{mdframed}
