...
\begin{center}
    \begin{tikzpicture}
        \begin{scope}[yscale=-1, yshift=-5cm, xshift=5cm, scale=0.4]
            ...
            % Draw x and y axes with arrows
            \draw[thick,->] (0,0) -- (18.5,0) node[anchor=north west] {\scriptsize x};
            \draw[thick,->] (0,0) -- (0,18.5) node[anchor=south east] {\scriptsize y};
            ...
            % Draw light gray grid lines
            \foreach \x in {1,2,...,17}
            \draw[lightgray,dashed] (\x,0) -- (\x,18);
            \foreach \y in {1,2,...,17}
            \draw[lightgray,dashed] (0,\y) -- (18,\y);
